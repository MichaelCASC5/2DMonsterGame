...
public:
     ...
     */
    Driver() : window(sf::VideoMode::getDesktopMode(), "2D Graphics", sf::Style::Fullscreen), runProgram(true), maze(8, 8), player(sf::Vector2f(100.0f,100.0f)), lives(3,"heart.png"), Timers(30) {
